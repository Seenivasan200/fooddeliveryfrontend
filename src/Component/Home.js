...
function Home() {
  return (
    <div>
       <table style={{backgroungColor: "darkgray"}}>
        <tr>
        <td>
    <th><img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSwv_26sHHw8EHJ1XzvVgopGzRSzAhUih1np-boi3T3UI9UrnIoXpdzXWwn8w&s"style={{height: "50px"}}/></th>
        </td>
        <td><h2>food delivery website</h2></td>
        <td>
    <th><input type="table" placeholder="Enter the your item"/></th>
<th><button>serach</button></th></td>
<td><nav className="b"><center><div className='a'/><a href="https://www.swiggy.com/about-us/">about</a><select/><option/>show more</center></nav></td>
<td><nav className="b"><center><div className='a'/><a href="#">offers</a><select><option/>show more<option>today offers</option> </select></center></nav></td>
<td><nav className="b"><center><div className='a'/><a href="#">help</a><select><option/>show more<option>contect no</option><option>address</option> </select></center></nav></td>
<td><nav className="b"><center><div className='a'/><a href="login.html" target="_blank" >sigin</a><select><option/>show more<option>login form</option><option>register form</option> </select></center></nav></td>
<td><nav className="b"><center><div className='a'/><a href="">card</a><select><option/>show more<option>favorites</option><option>order items</option> </select></center></nav></td>
<td/>
</tr>
</table><br/><br/>
...
<table >
    <tr>
        <th><img src="https://media-assets.swiggy.com/swiggy/image/upload/fl_lossy,f_auto,q_auto,w_288,h_360/MERCHANDISING_BANNERS/IMAGES/MERCH/2024/7/2/6ef07bda-b707-48ea-9b14-2594071593d1_Idli.png"className="aa"/></th>
        <th><img src="https://media-assets.swiggy.com/swiggy/image/upload/fl_lossy,f_auto,q_auto,w_288,h_360/MERCHANDISING_BANNERS/IMAGES/MERCH/2024/7/2/6ef07bda-b707-48ea-9b14-2594071593d1_Dosa.png" className="aa"/></th>
        <th><img src="https://media-assets.swiggy.com/swiggy/image/upload/fl_lossy,f_auto,q_auto,w_288,h_360/MERCHANDISING_BANNERS/IMAGES/MERCH/2024/7/2/6ef07bda-b707-48ea-9b14-2594071593d1_Poori.png" className="aa"/></th>
        <th><img src="https://media-assets.swiggy.com/swiggy/image/upload/fl_lossy,f_auto,q_auto,w_288,h_360/MERCHANDISING_BANNERS/IMAGES/MERCH/2024/7/2/6ef07bda-b707-48ea-9b14-2594071593d1_Biryani.png" className="aa"/></th>
        <th><img src="https://media-assets.swiggy.com/swiggy/image/upload/fl_lossy,f_auto,q_auto,w_288,h_360/MERCHANDISING_BANNERS/IMAGES/MERCH/2024/7/2/6ef07bda-b707-48ea-9b14-2594071593d1_Appam.png" className="aa"/></th>
        <th><img src="https://media-assets.swiggy.com/swiggy/image/upload/fl_lossy,f_auto,q_auto,w_288,h_360/MERCHANDISING_BANNERS/IMAGES/MERCH/2024/7/2/6ef07bda-b707-48ea-9b14-2594071593d1_Paratha.png" className="aa"/></th>
        <th><img src="https://media-assets.swiggy.com/swiggy/image/upload/fl_lossy,f_auto,q_auto,w_288,h_360/MERCHANDISING_BANNERS/IMAGES/MERCH/2024/7/2/8f508de7-e0ac-4ba8-b54d-def9db98959e_Vada.png" className="aa"/></th>
    </tr>
  </table>
  <table style={{backgroungColor: "lightcyan"}}>
<h2>Top Restaurant chains in your nearby</h2>
<tr>
...
<tr>
    <td><b>NH1 Bowls</b><br/>15-25 mins<br/>Fast Delivery</td>
...
<table style={{backgroungColor: "lightcyan"}}>
<h2>Veg & Non-veg & sweets Restaurantes</h2>
<tr>
